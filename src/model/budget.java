...
public class budget {
	...
	public budget(){
		...
		public double total_store(int[] materials_price, int[] materials_quantity, int general_amount, String location) {
		...
		public int utilizationGroups (String[] work, String typeUtilization) {
		...
		public String[] utilizationsArrays(String[] work, String typeUtilization, String[] material){
			int groups = utilizationGroups(work, typeUtilization);
